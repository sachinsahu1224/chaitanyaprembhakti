            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-title-box">
                        <h2>Activity</h2>
                        <p><a href="<?php echo base_url();?>">Home</a> / <a href="#">Activity</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="details-col">
                        <ul>
                            <li>
                                <i class="fa fa-hand-o-right" aria-hidden="true"></i> <strong>Activity :</strong><?php echo $row['name'] ;?>
                            </li>
                           <!--  <li>
