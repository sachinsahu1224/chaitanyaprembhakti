                        ...
                        <div class="col-xs-6 col-sm-4 col-md-3 filtr-item" data-category="3, 2" data-sort="value">
                            <div class="hover-box">
                                ...
                                <div class="hover-box-content">
                                  ...
                                  <a href="<?php echo base_url(); ?>Front/darshan/<?php echo $row['id']; ?>"><i class="fa fa-arrows" aria-hidden="true"></i></a>

                                    <p><a href="<?php echo base_url(); ?>Front/darshan/<?php echo $row['id']; ?>"><?php echo $row['temple_name'];?></a></p>
