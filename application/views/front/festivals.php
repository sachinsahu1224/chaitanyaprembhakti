        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-title-box">
                    <h2>Festivals</h2>
                    <p><a href="<?php echo base_url();?>">Home</a> / <a href="#">Festivals</a></p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="media-body">
                            ...
                            <p><?php echo $row['short_descrption']; ?></p>
                                <ul class="list-inline list-unstyled">
                                    <li><span><i class="glyphicon glyphicon-calendar"></i><?php echo $row['start_date']; ?> </span></li>
                                    <li>|</li>
                                 ...
                                 <li>|</li>
                                 <li><a href="<?php echo base_url().'singlefestival/'.$row['id'];?>">Read more...</a></li>
