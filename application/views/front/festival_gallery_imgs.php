            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-title-box">
                        ...
                        <p><a href="#"><?php echo $result['event_name'];?></a>
                        <p><a href="<?php echo base_url();?>">Home</a> / <a href="<?php echo site_url("image-gallery");?>">Image-gallery</a>/<a href="<?php echo site_url("festival-images");?>">Festival Images</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="portfolio-col">
                ...
                <li class="col-xs-6 col-sm-4 col-md-3" data-responsive="<?php echo base_url().$row['images'];?> " data-src="<?php echo base_url().$row['images'];?>" >
                    <a href="#" data-toggle="tooltip" data-placement="bottom" title="<?php echo $result['description'];?>">
                        <img class="img-responsive" src="<?php echo base_url().$row['images'];?>">
                    </a>
                </li>
