  ...
  <div class="graphs">
    ...
    <div class="tab-content">
      <div class="tab-pane active" id="horizontal-form">
        <form class="form-horizontal" action="<?php echo base_url(); ?>admin/add_gallery_images" method="post" enctype="multipart/form-data">
                  ...
                  <select class="form-control1" name="event">
                      ...
                      if(count($event_list) > 0){ 
                          foreach ($event_list as $key => $value) { ?>
                            <option value="<?php echo $value['id'];?>" <?php if($value['id'] == set_value('event
            ...
            <div class="form-group">
            	<label for="focusedinput" class="col-sm-2 control-label">Event Date <span class="text-danger">*</span></label>
                  ...
                  <div id="datepicker" class="input-group date" data-date-format="dd-mm-yyyy">
                    <input class="form-control" type="text" placeholder="Select date" name="upload_date" value="<?php echo set_value('upload_date');?>" readonly required=""/>
