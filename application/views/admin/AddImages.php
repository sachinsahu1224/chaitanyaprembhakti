...
<div id="page-wrapper">
  ...
  <div class="graphs">
    ...
    <h3 class="blank1">Add Images category</h3>
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane active" id="horizontal-form">
        ...
        <form class="form-horizontal" action="<?php echo base_url(); ?>AdminHome/addImagesData" method="post" enctype="multipart/form-data">
