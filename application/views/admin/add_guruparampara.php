<div id="page-wrapper">
  <div class="graphs">
    <h3 class="blank1">Add Guruparampara </h3>
    <?php
      ...
      <div class="tab-pane active" id="horizontal-form">
        <form class="form-horizontal" action="<?php echo current_url(); ?>" method="post" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control1" name="title" placeholder="Enter  name" required="" value="">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="focusedinput" class="col-sm-2 control-label">Iamge</label>
            <div class="col-sm-8">
            <input type="file" name="guruimg" required="">
            </div>
          </div>
          <div class="form-group">
