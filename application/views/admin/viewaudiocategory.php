...
<div id="page-wrapper">
  ...
  <div class="graphs">
    ...
    <h3 class="blank1">View Audio Category</h3>
          ...
          <tbody>
              ...
              foreach ($category as $row) {
               ...
               <!--    <td><a href="<?php echo base_url(); ?>AdminHome/editslide/<?php echo$row['id']; ?>""><button type="button" class="btn btn-info">Edit</button></a></td> -->
                  ...
                  <td><a href="<?php echo base_url(); ?>AdminHome/editaudiocategory/<?php echo$row['id']; ?>" class="btn btn-info">Edit</a>&nbsp;
                    <a href="<?php echo base_url(); ?>AdminHome/Deleteaudiocategory/<?php echo$row['id']; ?>" class="btn btn-danger">Delete</a>
                  </td>
