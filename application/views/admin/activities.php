  ...
  <div class="graphs">
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane active" id="horizontal-form">
        ...
        <form class="form-horizontal" action="<?php echo base_url(); ?>AdminHome/add_activity" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              ...
              <input type="text" class="form-control1" name="activity_name" placeholder="Enter Activity name" required="">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              ...
              <input type="number" name="sno"  placeholder="Enter name" required="" min="1">
