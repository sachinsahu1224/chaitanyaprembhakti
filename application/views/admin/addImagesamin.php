  ...
  <div class="graphs">
    ...
    <div class="tab-content">
      <div class="tab-pane active" id="horizontal-form">
        <form class="form-horizontal" action="<?php echo base_url(); ?>AdminHome/addImagesdaliy" method="post" enctype="multipart/form-data">
          <div class="form-group">
            <label for="focusedinput" class="col-sm-2 control-label">Name</label>
            <div class="col-sm-8">
              <input type="text" class="form-control1" name="product_name" placeholder="Enter  name" required="">
            </div>
          </div>
            <div class="form-group">
            ...
            <div class="col-sm-8">
                <select class="form-control1" name="category" required="">
                    ...
                    <?php
                        foreach($temple as $resultCategory){
                    ?>
