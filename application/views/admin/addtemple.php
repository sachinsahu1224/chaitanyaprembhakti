...
<div id="page-wrapper">
  ...
  <div class="graphs">
    ...
    <h3 class="blank1">Add Template</h3>
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane active" id="horizontal-form">
        ...
        <form class="form-horizontal" action="<?php echo base_url(); ?>AdminHome/addTempledata" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              ...
              <input type="text" class="form-control1" name="place" placeholder="Enter name" required="">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              ...
              <input type="text" class="form-control1" name="contact_person" placeholder="Enter contact person" required="">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control1" name="phone" placeholder="Enter name" required="">
           ...
           <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control1" name="mobile" placeholder="Enter name">
