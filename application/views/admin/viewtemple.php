...
<div id="page-wrapper">
  ...
  <div class="graphs">
    ...
    <h3 class="blank1">View Template</h3>
          ...
          <tbody>
              ...
              foreach ($temple as $row) {
               ...
               <!--    <td><a href="<?php echo base_url(); ?>AdminHome/editslide/<?php echo$row['id']; ?>""><button type="button" class="btn btn-info">Edit</button></a></td> -->
                  ...
                  <td>
                    <a href="<?php echo base_url(); ?>AdminHome/edittemplate/<?php echo$row['id']; ?>" class="btn btn-info">Edit</a>
                    <a href="<?php echo base_url(); ?>AdminHome/Deletetemplate/<?php echo$row['id']; ?>"><button type="button" class="btn btn-danger">Delete</button></a></td>
