    ...
    <div class="tab-content">
      <div class="tab-pane active" id="horizontal-form">
        <form class="form-horizontal" action="<?php echo current_url(); ?>" method="post" enctype="multipart/form-data">
          <?php foreach($video_links as $video_data){?>
          <div class="form-group">
            <label for="focusedinput" class="col-sm-2 control-label">Title</label>
            <div class="col-sm-8">
              <input type="text" class="form-control1" name="title" placeholder="Enter  Title" required="" value="<?php echo $video_data['title'];?>">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <textarea class="form-control" name="video_link_url" rows="3" required=""><?php echo $video_data['video_link_url'];?></textarea>
            ...
            <label for="focusedinput" class="col-sm-2 control-label"> Disable</label>
              ...
              <div class="col-sm-8">
                <select class="form-control1" name="status">
                  <option value="0" <?php if($video_data['video_link_url']=='0'){ echo "selected";}?> >No</option>
                  <option value="1" <?php if($video_data['video_link_url']=='1'){ echo "selected";}?> >Yes</option>
                </select>
              </div>
          </div>
          <div class="form-group">
            <label for="focusedinput" class="col-sm-2 control-label"> View in top</label>
              ...
              <div class="col-sm-8">
                <select class="form-control1" name="view_top_video">
                  <option value="0" <?php if($video_data['view_top_video']=='0'){ echo "selected";}?> >No</option>
                  <option value="1" <?php if($video_data['view_top_video']=='1'){ echo "selected";}?> >Yes</option>
                </select>
              </div>
          </div>
        <?php } ?>
