      ...
      <div class="tab-pane active" id="horizontal-form">
        <form class="form-horizontal" action="<?php echo current_url(); ?>" method="post" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control1" name="bookname" placeholder="Enter  name" required="" value="<?php echo $audio[0]['name'];?>">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <select class="form-control1" name="category" required="">
                ...
                foreach($category as $resultCategory){
                  ?>
                  <option value="<?php echo $resultCategory["id"]; ?>" <?php if($audio[0]['categoryid']==$resultCategory["id"]){ echo "selected" ;}?>><?php echo $resultCategory["name"]; ?></option>
                  <?php
                }
                ?>
              </select>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <textarea class="form-control" name="short_description" required=""><?php echo $audio[0]['description'];?></textarea>
              <script>
