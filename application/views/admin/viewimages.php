...
<div id="page-wrapper">
  ...
  <div class="graphs">
    ...
    <h3 class="blank1">View Images Category</h3>
          ...
          <tbody>
              ...
              foreach ($temple as $row) {
               ...
               <!--    <td><a href="<?php echo base_url(); ?>AdminHome/editslide/<?php echo$row['id']; ?>""><button type="button" class="btn btn-info">Edit</button></a></td> -->
                  ...
                  <td><a href="<?php echo base_url(); ?>AdminHome/editimagecategory/<?php echo$row['id']; ?>" class="btn btn-info">Edit</a>&nbsp;
                    <a href="<?php echo base_url(); ?>AdminHome/Deleteimagescategory/<?php echo$row['id']; ?>" class="btn btn-danger">Delete</a></td>
