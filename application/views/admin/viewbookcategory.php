...
<div id="page-wrapper">
  ...
  <div class="graphs">
    ...
    <h3 class="blank1">View Book Category</h3>
          ...
          <tbody>
              ...
              foreach ($category as $row) {
               ...
               <!--    <td><a href="<?php echo base_url(); ?>AdminHome/editslide/<?php echo$row['id']; ?>""><button type="button" class="btn btn-info">Edit</button></a></td> -->
                  ...
                  <td><a href="<?php echo base_url(); ?>AdminHome/Deletebookcategory/<?php echo$row['id']; ?>"><button type="button" class="btn btn-danger">Delete</button></a></td>
