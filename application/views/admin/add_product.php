  ...
  <div class="graphs">
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane active" id="horizontal-form">
        ...
        <form class="form-horizontal" action="<?php echo base_url(); ?>admin/addproduct" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              ...
              <input type="text" class="form-control1" name="product_name" placeholder="Enter Event name" required="">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              ...
              <input type="date" class="form-control1" name="starttdate" id="txtFrom" required="">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              ...
              <input type="date" class="form-control1" name="enddate" id="txtTo" required="">
