...
jQuery(document).ready(function($) {
	...
	$("ul.colors .color2" ).click(function(){
		$("#colors" ).attr("href", "css/color-css/colors/color-2.css" );
		return false;
	});

	$("ul.colors .color3" ).click(function(){
		$("#colors" ).attr("href", "css/color-css/colors/color-3.css" );
		return false;
	});

	$("ul.colors .color4" ).click(function(){
		$("#colors" ).attr("href", "css/color-css/colors/color-4.css" );
		return false;
	});

	$("ul.colors .color5" ).click(function(){
		$("#colors" ).attr("href", "css/color-css/colors/color-5.css" );
		return false;
	});

	$("ul.colors .color6" ).click(function(){
		$("#colors" ).attr("href", "css/color-css/colors/color-6.css" );
		return false;
	});

	$("ul.colors .color7" ).click(function(){
		$("#colors" ).attr("href", "css/color-css/colors/color-7.css" );
		return false;
	});
	$("ul.colors .color8" ).click(function(){
		$("#colors" ).attr("href", "css/color-css/colors/color-8.css" );
		return false;
	});

	$("ul.colors .color9" ).click(function(){
		$("#colors" ).attr("href", "css/color-css/colors/color-9.css" );
		return false;
	});

	$("ul.colors .color10" ).click(function(){
		$("#colors" ).attr("href", "css/color-css/colors/color-10.css" );
		return false;
	});

	$("ul.colors .color11" ).click(function(){
		$("#colors" ).attr("href", "css/color-css/colors/color-11.css" );
		return false;
	});
	$("ul.colors .color12" ).click(function(){
		$("#colors" ).attr("href", "css/color-css/colors/color-12.css" );
		return false;
	});
...
jQuery('head').append('<link rel="stylesheet" id="colors" href="css/color-css/colors/default.css" type="text/css" />');
jQuery('head').append('<link rel="stylesheet" href="css/color-css/color-switcher.css" type="text/css" />'); 
